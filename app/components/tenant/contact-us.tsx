      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <motion.h4 
            ...
            className="text-stone-500 font-bold tracking-widest uppercase text-sm mb-3"
          >
            Get In Touch
          </motion.h4>
          <motion.h2 
          ...
          >
            Hubungi Tim <span className="text-stone-600">LuxeStay</span>
          </motion.h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <motion.div 
            ...
            className="lg:col-span-1 bg-stone-900 rounded-[2rem] p-8 text-white relative overflow-hidden shadow-2xl shadow-stone-300"
          >
            {/* Background Decor */}
          ...
          <motion.div 
            initial={{ opacity: 0, x: 30 }}
            whileInView={{ opacity: 1, x: 0 }}
            className="lg:col-span-2 bg-white rounded-[2rem] p-10 shadow-xl shadow-slate-200 border border-slate-100"
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input 
                    ...
                    className="h-12 rounded-xl border-slate-200 focus:ring-stone-500" 
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <div>
                    <Input 
                      ...
                      className={`h-12 rounded-xl border-slate-200 focus:ring-stone-500 ${emailError ? 'border-red-500' : ''}`}
                    />
              ...
              <div className="space-y-2">
                ...
                <select 
                  ...
                  onChange={handleChange}
                  className="w-full h-12 px-4 rounded-xl border border-slate-200 bg-white text-sm focus:outline-none focus:ring-2 focus:ring-stone-500 transition-all"
                >
              ...
              <div className="space-y-2">
                ...
                <textarea 
                  ...
                  onChange={handleChange}
                  rows={4} 
                  className="w-full p-4 rounded-xl border border-slate-200 bg-white text-sm focus:outline-none focus:ring-2 focus:ring-stone-500 transition-all"
              ...
              <Button 
                type="submit"
                disabled={loading}
                className="w-full md:w-auto px-10 h-12 bg-stone-900 hover:bg-stone-800 disabled:bg-stone-600 text-white rounded-xl flex items-center gap-2 group transition-all"
              >
                {loading ? (
                  <>
